...
- Tablet 835×950: pricing layout inspected; tightened value-to-bar spacing. Hero 402 → explicit simulated payment → response verified, followed by payload and reset.
